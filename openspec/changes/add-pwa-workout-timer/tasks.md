...
**Acceptance hooks**: pwa — "Manifest is valid", "Full offline session after first load", "No service worker support", "Shortcuts where supported, absent harmlessly elsewhere"; local-data — "Offline end-to-end"; closes design risk R5 by evidence. Evidence reconciliation retains the canonical **40 requirements / 79 scenarios**: “Natural Completion Summary” is a requirement heading, not an 80th scenario.
